...
<header id="header">
  ...
  <div id="content" class="py-4">
    ...
    <div class="row mt-4 mb-5">
      ...
      <h2 class="fw-400 text-center mt-3">Fill in your details</h2>
      ...
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
          <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <div class="mb-3">
                <label for="youSend" class="form-label">First Name</label>
                <div class="input-group">
                
                  <input type="text" class="form-control" data-bv-field="youSend" id="username" name="firstname" required placeholder="Cruz" onChange={(e) => setFirstName(e.target.value)} />
                  
                </div>
            </div>

            <div class="mb-3">
                <label for="youSend" class="form-label">Last Name</label>
                <div class="input-group">
                
                  <input type="text" class="form-control" data-bv-field="youSend" id="username" name="lastname" required onChange={(e) => setLastName(e.target.value)}  placeholder="John" />
                  
                </div>
            </div>
            <div class="mb-3">
                <label for="youSend" class="form-label">Date of Birth</label>
                <div class="input-group">
                
                  <input type="text" class="form-control" data-bv-field="youSend" id="username" name="dateofbirth" required onChange={(e) => setDate(e.target.value)}  placeholder="2000-01-01" />
                  <span class="input-group-text p-0">
                    <select id="youSendCurrency" data-style="form-select bg-transparent border-0" data-container="body" name="currency_code" required onChange={(e) => setGender(e.target.value)}  data-live-search="true" class="selectpicker form-control bg-transparent">
                    <option data-icon="currency-flag currency-flag-usd me-1" data-subtext="United States dollar"  value="">Gender <i class="bi bi-arrow-down"></i></option>
                    
                        <option data-icon="currency-flag currency-flag-usd me-1" data-subtext="United States dollar"  value="male">Male</option>
                        <option data-icon="currency-flag currency-flag-usd me-1" data-subtext="United States dollar"  value="female">Female</option>
                    </select>
                  </span>
                </div>
            </div>
              ...
              <div class="mb-3">
                <label for="youSend" class="form-label">National/Passport ID Number</label>
                <div class="input-group">
                  <input type="text" class="form-control" data-bv-field="youSend" id="youSend" required onChange={(e) => setNin(e.target.value)} name="nin" placeholder="CFX002224455566" />
