      ...
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto"> 
          <div class="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <p class="text-3 mb-4">You've Succesfully Withdrawn <span class="text-4 fw-500">{location.state.amount} {location.state.currency}</span> to <span class="fw-500">{location.state.phone}</span>, See transaction details under <a class="btn-link" href="/eremit/#/dashboard">Your wallet</a>.</p>
            <div class="d-grid"><a href="/eremit/#/withdraw"><button class="btn btn-primary">Withdraw Money Again</button></a></div>
